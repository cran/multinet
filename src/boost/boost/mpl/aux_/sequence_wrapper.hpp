...
struct
BOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser);
}
#endif
...
template<
    ...
    >
struct
BOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)
{
...
{
    typedef typename
    AUX778076_SEQUENCE_NAME_N(i_)< AUX778076_SEQUENCE_N_ARGS(i_) >::type type;
};
...
template<>
struct
BOOST_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser)<i_>
{
    template<
        AUX778076_SEQUENCE_PARAMS()
        >
