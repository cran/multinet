...
aux::no_tag
is_bind_helper(...);
template< typename T > aux::no_tag
...
template<
    ...
    >
aux::yes_tag
is_bind_helper(bind<F,AUX778076_BIND_PARAMS(T)>*);
#endif

template< BOOST_MPL_AUX_NTTP_DECL(int, N) >
aux::yes_tag
is_bind_helper(arg<N>*);
...
{
    typedef
    BOOST_PP_CAT(bind,i_)<F AUX778076_BIND_N_PARAMS(i_,T)> f_;
    typedef typename AUX778076_APPLY<f_, AUX778076_BIND_PARAMS(U)>::type type;
};
...
struct bind_chooser<i_>
{
    ...
    {
        typedef
        BOOST_PP_CAT(bind,i_)< F AUX778076_BIND_N_PARAMS(i_,T) > type;
    };
};
...
BOOST_PP_CAT(r,j_);
typedef typename
BOOST_PP_CAT(r,j_)::type BOOST_PP_CAT(a,j_);
typedef typename
BOOST_PP_CAT(r,j_)::next BOOST_PP_CAT(n,BOOST_PP_INC(j_));
