...
struct positive_accumulator
{
    ...
    inline static void
    add(T& n, Char ch, mpl::false_) // unchecked add
    {
    ...
    template <typename T, typename Char>
    inline static bool
    add(T& n, Char ch, mpl::true_) // checked add
    {
...
struct negative_accumulator
{
    template <typename T, typename Char>
    inline static void
    add(T& n, Char ch, mpl::false_) // unchecked subtract
    {
        const int digit = radix_traits<Radix>::digit(ch);
        n = n * T(Radix) - T(digit);
    }
    ...
    template <typename T, typename Char>
    inline static bool
    add(T& n, Char ch, mpl::true_) // checked subtract
    {
