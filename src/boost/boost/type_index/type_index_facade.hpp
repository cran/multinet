...
class type_index_facade
{
  private:
    /// @cond
    BOOST_CXX14_CONSTEXPR const Derived &
  ...
  public:
    ...
    inline bool
    equal(const Derived& rhs) const BOOST_NOEXCEPT
    {
    ...
    inline bool
    before(const Derived& rhs) const BOOST_NOEXCEPT
    {
        const char* const left = derived().raw_name();
        const char* const right = rhs.raw_name();
...
operator == (const type_index_facade<Derived, TypeInfo>& lhs, const type_index_facade<Derived, TypeInfo>& rhs) BOOST_NOEXCEPT
{
...
template <class Derived, class TypeInfo>
inline bool
operator == (const TypeInfo& lhs, const type_index_facade<Derived, TypeInfo>& rhs) BOOST_NOEXCEPT
{
...
template <class Derived, class TypeInfo>
inline bool
operator == (const type_index_facade<Derived, TypeInfo>& lhs, const TypeInfo& rhs) BOOST_NOEXCEPT
{
...
bool
operator ==, !=, <, ... (const type_index_facade& lhs, const type_index_facade& rhs) noexcept;

/// noexcept comparison operators for type_index_facade and it's TypeInfo classes.
bool
operator ==, !=, <, ... (const type_index_facade& lhs, const TypeInfo& rhs) noexcept;

/// noexcept comparison operators for type_index_facade's TypeInfo and type_index_facade classes.
bool
operator ==, !=, <, ... (const TypeInfo& lhs, const type_index_facade& rhs) noexcept;
...
template <class Derived, class TypeInfo>
inline std::ostream&
operator<<(std::ostream& ostr, const type_index_facade<Derived, TypeInfo>& ind)
{
