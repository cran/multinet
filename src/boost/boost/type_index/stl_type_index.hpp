      ...
      >
{
  ...
  :
    ...
    inline bool
    equal(const stl_type_index& rhs) const BOOST_NOEXCEPT;
    inline bool
    before(const stl_type_index& rhs) const BOOST_NOEXCEPT;

    template <class T>
    inline static stl_type_index
    ...
    template <class T>
    inline static stl_type_index
    type_id_runtime(const T& value) BOOST_NOEXCEPT;
};
...
inline const char*
stl_type_index::raw_name() const BOOST_NOEXCEPT
{
#ifdef _MSC_VER
...
inline const char*
stl_type_index::name() const BOOST_NOEXCEPT
{
    return data_->name();
}

inline std::string
stl_type_index::pretty_name() const
{
...
inline std::size_t
stl_type_index::hash_code() const BOOST_NOEXCEPT
{
...
stl_type_index::type_id() BOOST_NOEXCEPT
{
...
template <class T>
inline stl_type_index
stl_type_index::type_id_with_cvr() BOOST_NOEXCEPT
{
    typedef BOOST_DEDUCED_TYPENAME boost::conditional<
