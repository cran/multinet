...
BOOST_CXX14_CONSTEXPR inline void
assert_compile_time_legths() BOOST_NOEXCEPT
{
...
template <class T>
BOOST_CXX14_CONSTEXPR inline void
failed_to_get_function_name() BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        sizeof(T) && false,
...
BOOST_CXX14_CONSTEXPR BOOST_FORCEINLINE bool
is_constant_string(const char* str) BOOST_NOEXCEPT
{
...
skip_begining_runtime(const char* begin, boost::false_type) BOOST_NOEXCEPT
{
    return begin;
}

template<class ForwardIterator1, class ForwardIterator2>
BOOST_CXX14_CONSTEXPR inline ForwardIterator1
constexpr_search(
...
BOOST_CXX14_CONSTEXPR inline int
constexpr_strcmp_loop(const char *v1, const char *v2) BOOST_NOEXCEPT
{
    while (*v1 != '\0' && *v1 == *v2)
    {
        ++v1;
...
BOOST_CXX14_CONSTEXPR inline int
constexpr_strcmp(const char *v1, const char *v2) BOOST_NOEXCEPT
{
...
template <unsigned int ArrayLength>
BOOST_CXX14_CONSTEXPR inline const char*
skip_begining_runtime(const char* begin, boost::true_type) BOOST_NOEXCEPT
{
...
template <unsigned int ArrayLength>
BOOST_CXX14_CONSTEXPR inline const char*
skip_begining(const char* begin) BOOST_NOEXCEPT
{
...
struct ctti
{
    ...
    impl(::boost::typeindex::detail::index_seq<Indexes...> ) BOOST_NOEXCEPT
    {
    ...
    BOOST_CXX14_CONSTEXPR static const char*
    n() BOOST_NOEXCEPT
    {
#if defined(BOOST_TYPE_INDEX_FUNCTION_SIGNATURE)
