...
struct source_location
{
  ...
  public:
    ...
    BOOST_CONSTEXPR
  source_location() BOOST_NOEXCEPT:
    file_( "" ), function_( "" ), line_( 0 ), column_( 0 )
    {
    }

    BOOST_CONSTEXPR
  source_location( char const * file, boost::uint_least32_t ln, char const * function, boost::uint_least32_t col = 0 ) BOOST_NOEXCEPT:
    ...
    BOOST_CONSTEXPR
  source_location( std::source_location const& loc ) BOOST_NOEXCEPT:
    ...
    BOOST_CONSTEXPR char const *
    file_name() const BOOST_NOEXCEPT
    {
        return file_;
    }

    BOOST_CONSTEXPR char const *
    function_name() const BOOST_NOEXCEPT
    {
        return function_;
    }

    BOOST_CONSTEXPR boost::uint_least32_t
    line() const BOOST_NOEXCEPT
    {
        return line_;
    }

    BOOST_CONSTEXPR boost::uint_least32_t
    column() const BOOST_NOEXCEPT
    {
        return column_;
    }
...
# pragma warning( pop )
    ...
    inline friend bool
    operator==( source_location const& s1, source_location const& s2 ) BOOST_NOEXCEPT
    {
