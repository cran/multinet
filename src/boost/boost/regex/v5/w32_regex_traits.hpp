...
#endif
bool
w32_is(lcid_type, std::uint32_t mask, char c);
#ifndef BOOST_NO_WREGEX
bool
w32_is(lcid_type, std::uint32_t mask, wchar_t c);
#endif
...
class w32_regex_traits_char_layer : public w32_regex_traits_base<charT>
{
  ...
  public:
    ...
    bool
    isctype(std::uint32_t mask, charT c)const
    {
...
class w32_regex_traits_char_layer<char> : public w32_regex_traits_base<char>
{
  ...
  public:
    ...
    bool
    isctype(std::uint32_t mask, char c)const
    {
...
#endif
inline bool
w32_is(lcid_type idx, std::uint32_t m, char c)
{
    word mask;
#ifndef BOOST_NO_ANSI_APIS
...
#ifndef BOOST_NO_WREGEX
inline bool
w32_is(lcid_type idx, std::uint32_t m, wchar_t c)
{
    word mask;
