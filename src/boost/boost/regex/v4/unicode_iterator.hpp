...
inline bool
is_high_surrogate(::boost::uint16_t v)
{
    return (v & 0xFFFFFC00u) == 0xd800u;
}
inline bool
is_low_surrogate(::boost::uint16_t v)
{
...
inline unsigned
utf8_byte_count(boost::uint8_t c)
{
...
inline unsigned
utf8_trailing_byte_count(boost::uint8_t c)
{
...
#endif
inline void
invalid_utf32_code_point(::boost::uint32_t val)
{
#ifndef BOOST_NO_STD_LOCALE
    std::stringstream ss;
...
class u32_to_u16_iterator
{
  ...
  public:
    ...
    bool
    operator==(const u32_to_u16_iterator& that)const
    {
...
class u16_to_u32_iterator
{
  ...
  public:
    ...
    bool
    operator==(const u16_to_u32_iterator& that)const
    {
  ...
  private:
    static void
    invalid_code_point(::boost::uint16_t val)
    {
#ifndef BOOST_NO_STD_LOCALE
        std::stringstream ss;
...
class u32_to_u8_iterator
{
  ...
  public:
    ...
    bool
    operator==(const u32_to_u8_iterator& that)const
    {
        if (m_position == that.m_position)
        {
...
class u8_to_u32_iterator
{
  ...
  public:
    ...
    bool
    operator==(const u8_to_u32_iterator& that)const
    {
        return m_position == that.m_position;
    }
    bool
...
class utf16_output_iterator
{
  public:
    ...
    operator=(const utf16_output_iterator& that)
    {
        m_position = that.m_position;
        return *this;
    }
    const utf16_output_iterator&
    operator*()const
    {
        return *this;
    }
    void
    operator=(boost::uint32_t val)const
    {
        push(val);
    }
    utf16_output_iterator&
...
class utf8_output_iterator
{
  public:
    ...
    operator=(const utf8_output_iterator& that)
    {
        m_position = that.m_position;
        return *this;
    }
