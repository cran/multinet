...
inline bool
regex_search(const std::basic_string<charT, ST, SA>& s,
...
inline bool
regex_search(const char* first, const char* last,
             const regex& e,
             match_flag_type flags = match_default)
{
    cmatch m;
...
inline bool
regex_search(const wchar_t* str,
             wcmatch& m,
             const wregex& e,
             match_flag_type flags = match_default)
{
...
inline bool
regex_search(const wchar_t* first, const wchar_t* last,
             const wregex& e,
             match_flag_type flags = match_default)
{
    wcmatch m;
...
#endif
inline bool
regex_search(const std::string& s,
             smatch& m,
             const regex& e,
             match_flag_type flags = match_default)
{
...
inline bool
regex_search(const std::basic_string<wchar_t>& s,
             wsmatch& m,
             const wregex& e,
             match_flag_type flags = match_default)
{
