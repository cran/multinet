...
class regex_token_iterator_implementation
{
  ...
  public:
    ...
    bool
    compare(const regex_token_iterator_implementation& that)
    {
        if (this == &that)
        {
            return true;
  ...
  private:
    ...
    operator=(const regex_token_iterator_implementation&);
};
...
class regex_token_iterator
{
  ...
  public:
    ...
    regex_token_iterator(const regex_token_iterator& that)
        : pdata(that.pdata) {}
    regex_token_iterator&
    operator=(const regex_token_iterator& that)
    {
        pdata = that.pdata;
        return *this;
    }
    bool
    operator==(const regex_token_iterator& that)const
    {
...
inline regex_token_iterator<const charT*, charT, traits>
