...
template <class charT>
inline lcid_type
w32_regex_traits_base<charT>::imbue(lcid_type l)
{
...
class w32_regex_traits_char_layer : public w32_regex_traits_base<charT>
{
  ...
  public:
    ...
    syntax_type(charT c)const
    {
        map_iterator_type i = m_char_map.find(c);
        return ((i == m_char_map.end()) ? 0 : i->second);
    }
    regex_constants::escape_syntax_type
    escape_syntax_type(charT c) const
    {
        map_iterator_type i = m_char_map.find(c);
    ...
    bool
    isctype(boost::uint32_t mask, charT c)const
    {
...
class w32_regex_traits_char_layer<char> : public w32_regex_traits_base<char>
{
  ...
  public:
    ...
    regex_constants::syntax_type
    syntax_type(char c)const
    {
        return m_char_map[static_cast<unsigned char>(c)];
    }
    regex_constants::escape_syntax_type
    escape_syntax_type(char c) const
    {
        return m_char_map[static_cast<unsigned char>(c)];
    }
    char
    ...
    bool
    isctype(boost::uint32_t mask, char c)const
    {
...
class w32_regex_traits_implementation : public w32_regex_traits_char_layer<charT>
{
  public:
    ...
    std::string
    error_string(regex_constants::error_type n) const
    {
    ...
    char_class_type
    lookup_classname(const charT* p1, const charT* p2) const
    {
    ...
    string_type
    lookup_collatename(const charT* p1, const charT* p2) const;
    string_type
    transform_primary(const charT* p1, const charT* p2) const;
    string_type
    transform(const charT* p1, const charT* p2) const
    {
  ...
  private:
    ...
    //
    char_class_type
    lookup_classname_imp(const charT* p1, const charT* p2) const;
};
...
template <class charT>
boost::shared_ptr<const w32_regex_traits_implementation<charT> >
...
class w32_regex_traits
{
  public:
    ...
    charT
    translate(charT c, bool icase) const
    {
    ...
    bool
    isctype(charT c, char_class_type f) const
    {
    ...
    //
    static std::string
    catalog_name(const std::string& name);
    static std::string
    get_catalog_name();
...
template <class charT>
std::string
w32_regex_traits<charT>::catalog_name(const std::string& name)
{
#ifdef BOOST_HAS_THREADS
...
template <class charT>
std::string&
w32_regex_traits<charT>::get_catalog_name_inst()
{
...
template <class charT>
std::string
w32_regex_traits<charT>::get_catalog_name()
{
#ifdef BOOST_HAS_THREADS
    static_mutex::scoped_lock lk(get_mutex_inst());
#endif
...
template <class charT>
static_mutex&
w32_regex_traits<charT>::get_mutex_inst()
{
...
template <class U>
inline void
w32_regex_traits_char_layer<char>::init()
{
    // we need to start by initialising our syntax map so we know which
    // character is used for which purpose:
...
inline lcid_type BOOST_REGEX_CALL
w32_get_default_locale()
{
    return ::GetUserDefaultLCID();
}

inline bool BOOST_REGEX_CALL
w32_is_lower(char c, lcid_type idx)
{
#ifndef BOOST_NO_ANSI_APIS
    WORD mask;
...
inline bool BOOST_REGEX_CALL
w32_is_lower(wchar_t c, lcid_type idx)
{
    WORD mask;
...
inline bool BOOST_REGEX_CALL
w32_is_upper(char c, lcid_type idx)
{
#ifndef BOOST_NO_ANSI_APIS
    WORD mask;
...
inline bool BOOST_REGEX_CALL
w32_is_upper(wchar_t c, lcid_type idx)
{
    WORD mask;
...
inline void
free_module(void* mod)
{
    ::FreeLibrary(static_cast<HMODULE>(mod));
}

inline cat_type BOOST_REGEX_CALL
w32_cat_open(const std::string& name)
{
#ifndef BOOST_NO_ANSI_APIS
...
inline std::string BOOST_REGEX_CALL
...
#ifndef BOOST_NO_WREGEX
inline std::wstring BOOST_REGEX_CALL
...
#endif
inline std::string BOOST_REGEX_CALL
w32_transform(lcid_type idx, const char* p1, const char* p2)
{
#ifndef BOOST_NO_ANSI_APIS
...
#endif
inline char BOOST_REGEX_CALL
w32_tolower(char c, lcid_type idx)
{
    char result[2];
#ifndef BOOST_NO_ANSI_APIS
    int b = ::LCMapStringA(
...
#ifndef BOOST_NO_WREGEX
inline wchar_t BOOST_REGEX_CALL
w32_tolower(wchar_t c, lcid_type idx)
{
    wchar_t result[2];
    int b = ::LCMapStringW(
                idx,       // locale identifier
...
#endif
inline char BOOST_REGEX_CALL
w32_toupper(char c, lcid_type idx)
{
    char result[2];
#ifndef BOOST_NO_ANSI_APIS
    int b = ::LCMapStringA(
...
#ifndef BOOST_NO_WREGEX
inline wchar_t BOOST_REGEX_CALL
w32_toupper(wchar_t c, lcid_type idx)
{
    wchar_t result[2];
    int b = ::LCMapStringW(
                idx,       // locale identifier
...
#endif
inline bool BOOST_REGEX_CALL
w32_is(lcid_type idx, boost::uint32_t m, char c)
{
    WORD mask;
#ifndef BOOST_NO_ANSI_APIS
...
#ifndef BOOST_NO_WREGEX
inline bool BOOST_REGEX_CALL
w32_is(lcid_type idx, boost::uint32_t m, wchar_t c)
{
    WORD mask;
