...
struct c_regex_traits<char>
{
    ...
    char
    translate(char c) const
    {
        return c;
    }
    char
    translate_nocase(char c) const
    {
        return static_cast<char>((std::tolower)(static_cast<unsigned char>(c)));
    }

    static string_type BOOST_REGEX_CALL
    transform(const char* p1, const char* p2);
    static string_type BOOST_REGEX_CALL
    transform_primary(const char* p1, const char* p2);

    static char_class_type BOOST_REGEX_CALL
    lookup_classname(const char* p1, const char* p2);
    static string_type BOOST_REGEX_CALL
    lookup_collatename(const char* p1, const char* p2);

    static bool BOOST_REGEX_CALL
    isctype(char, char_class_type);
    static int BOOST_REGEX_CALL
    value(char, int);
...
struct c_regex_traits<wchar_t>
{
    ...
    wchar_t
    translate(wchar_t c) const
    {
        return c;
    }
    wchar_t
    translate_nocase(wchar_t c) const
    {
        return (std::towlower)(c);
    }

    static string_type BOOST_REGEX_CALL
    transform(const wchar_t* p1, const wchar_t* p2);
    static string_type BOOST_REGEX_CALL
    transform_primary(const wchar_t* p1, const wchar_t* p2);

    static char_class_type BOOST_REGEX_CALL
    lookup_classname(const wchar_t* p1, const wchar_t* p2);
    static string_type BOOST_REGEX_CALL
    lookup_collatename(const wchar_t* p1, const wchar_t* p2);

    static bool BOOST_REGEX_CALL
    isctype(wchar_t, char_class_type);
    static int BOOST_REGEX_CALL
    value(wchar_t, int);
...
inline c_regex_traits<char>::string_type BOOST_REGEX_CALL
...
inline c_regex_traits<char>::char_class_type BOOST_REGEX_CALL
...
c_regex_traits<char>::isctype(char c, char_class_type mask)
{
    using namespace BOOST_REGEX_DETAIL_NS;
    return
...
inline int BOOST_REGEX_CALL
c_regex_traits<char>::value(char c, int radix)
{
    char b[2] = { c, '\0', };
    char* ep;
...
inline c_regex_traits<wchar_t>::string_type BOOST_REGEX_CALL
...
inline c_regex_traits<wchar_t>::char_class_type BOOST_REGEX_CALL
...
inline bool BOOST_REGEX_CALL
c_regex_traits<wchar_t>::isctype(wchar_t c, char_class_type mask)
{
    using namespace BOOST_REGEX_DETAIL_NS;
    return
...
inline int BOOST_REGEX_CALL
c_regex_traits<wchar_t>::value(wchar_t c, int radix)
{
