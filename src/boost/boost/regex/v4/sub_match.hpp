...
struct sub_match : public std::pair<BidiIterator, BidiIterator>
{
...
#endif
    difference_type BOOST_REGEX_CALL
    length()const
    {
    ...
    int
    compare(const sub_match& s)const
    {
    ...
    int
    compare(const std::basic_string<value_type>& s)const
    {
    ...
    bool
    operator==(const sub_match& that)const
    {
...
int
do_toi(BidiIterator i, BidiIterator j, char c, int radix)
{
    std::string s(i, j);
    char* p;
