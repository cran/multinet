...
inline const char* BOOST_REGEX_CALL
...
inline regex_constants::syntax_type BOOST_REGEX_CALL
...
inline regex_constants::escape_syntax_type BOOST_REGEX_CALL
...
template <>
inline bool is_combining<char>
(char)
{
    return false;
}
template <>
inline bool is_combining<signed char>
(signed char)
{
    return false;
}
template <>
inline bool is_combining<unsigned char>
(unsigned char)
{
    return false;
}
...
struct character_pointer_range
{
    ...
    bool
    operator < (const character_pointer_range& r)const
    {
...
template <class charT>
int
get_default_class_id(const charT* p1, const charT* p2)
{
...
template<>
inline std::ptrdiff_t global_length<char>
(const char* p)
{
    return (std::strlen)(p);
}
...
template<>
inline std::ptrdiff_t global_length<wchar_t>
(const wchar_t* p)
{
...
//
template<> inline char BOOST_REGEX_CALL global_lower<char>
(char c)
{
    return do_global_lower(c);
}
template<> inline char BOOST_REGEX_CALL global_upper<char>
(char c)
{
    return do_global_upper(c);
}
#ifndef BOOST_NO_WREGEX
template<> inline wchar_t BOOST_REGEX_CALL global_lower<wchar_t>
(wchar_t c)
{
    return do_global_lower(c);
}
template<> inline wchar_t BOOST_REGEX_CALL global_upper<wchar_t>
(wchar_t c)
{
    return do_global_upper(c);
}
...
boost::intmax_t
global_toi(const charT*& p1, const charT* p2, int radix, const traits& t)
{
