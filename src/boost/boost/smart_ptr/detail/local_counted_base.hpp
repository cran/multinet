...
class BOOST_SYMBOL_VISIBLE local_counted_base
{
  private:
    ...
    local_counted_base &
    operator= ( local_counted_base const & );
...
# endif
    ...
    long
    local_use_count() const BOOST_SP_NOEXCEPT
    {
...
class BOOST_SYMBOL_VISIBLE local_counted_impl: public local_counted_base
{
  ...
  public:
    ...
    explicit
  local_counted_impl( shared_count const& pn ) BOOST_SP_NOEXCEPT:
    pn_( pn )
    {
    }
    ...
    explicit
  local_counted_impl( shared_count && pn ) BOOST_SP_NOEXCEPT:
    pn_( std::move(pn) )
    {
    }
    ...
    void
    local_cb_destroy() BOOST_SP_NOEXCEPT BOOST_OVERRIDE
    {
        delete this;
    }

    boost::detail::shared_count
    local_cb_get_shared_count() const BOOST_SP_NOEXCEPT BOOST_OVERRIDE
    {
        return pn_;
    }
};
