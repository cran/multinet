...
class apply_visitor_binary_invoke
{
  ...
  private:
    ...
    operator=(const apply_visitor_binary_invoke&);
};
...
class apply_visitor_binary_unwrap
{
  ...
  private:
    apply_visitor_binary_unwrap&
    operator=(const apply_visitor_binary_unwrap&);
...
class apply_visitor_binary_invoke_cpp14
{
  ...
  private:
    ...
    operator=(const apply_visitor_binary_invoke_cpp14&);
};
...
class apply_visitor_binary_unwrap_cpp14
{
  ...
  private:
    apply_visitor_binary_unwrap_cpp14&
...
template <typename Visitor, typename Visitable1, typename Visitable2>
inline
decltype(auto) apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
...
template <typename Visitor, typename Visitable1, typename Visitable2>
inline
decltype(auto) apply_visitor(const Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
                             typename boost::disable_if<
                             boost::detail::variant::has_result_type<Visitor>,
                             bool
                             >::type = true)
