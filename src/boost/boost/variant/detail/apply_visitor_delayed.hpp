...
class apply_visitor_delayed_t
{
  ...
  public: // structors
    ...
    explicit
    apply_visitor_delayed_t(Visitor& visitor) BOOST_NOEXCEPT
  :
    visitor_(visitor)
    {
    }
  ...
  private:
    ...
    operator=(const apply_visitor_delayed_t&);
...
class apply_visitor_delayed_cpp14_t
{
  ...
  public: // structors
    ...
    explicit
    apply_visitor_delayed_cpp14_t(Visitor& visitor) BOOST_NOEXCEPT
  :
    visitor_(visitor)
    {
    }
  ...
  private:
    ...
    operator=(const apply_visitor_delayed_cpp14_t&);
