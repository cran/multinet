...
struct result_multideduce1
{
    ...
    struct deduce_impl
    {
        ...
        typedef
        decltype(true ? boost::declval< Visitor& >()( boost::declval< copy_cv_ref_t< value_t, Variant > >() )
    ...
    struct deduce_impl<last_it, Dummy>
    {
        ...
        typedef
        decltype(boost::declval< Visitor& >()( boost::declval< copy_cv_ref_t< value_t, Variant > >() )) type;
    };
...
struct result_wrapper1
{
    ...
    Visitor&& visitor_;
    explicit
    result_wrapper1(Visitor&& visitor) BOOST_NOEXCEPT
        :
...
template <typename Visitor, typename Visitable>
inline
decltype(auto) apply_visitor(Visitor&& visitor, Visitable&& visitable,
