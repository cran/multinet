    ...
    : public static_visitor<T&>
{
  ...
  public: // visitor interface
    ...
    T&
    operator()(T& operand) const BOOST_NOEXCEPT
    {
        return operand;
    }
    ...
    : public static_visitor<>
{
  ...
  public: // structors
    ...
    explicit
    move_into(void* storage) BOOST_NOEXCEPT
  :
    storage_(storage)
    {
    }
    ...
    : public static_visitor<>
{
  ...
  public: // structors
    ...
    explicit
    assign_storage(const void* rhs_storage) BOOST_NOEXCEPT
  :
    ...
    : public static_visitor<>
{
  ...
  public: // structors
    ...
    explicit
    move_storage(void* rhs_storage) BOOST_NOEXCEPT
  :
    rhs_storage_(rhs_storage)
    {
    }
    ...
    : public static_visitor<bool>
{
  ...
  private:
    ...
    direct_assigner&
    operator= (direct_assigner const&);
#endif
};
    ...
    : public static_visitor<>
{
  ...
  private: // helpers, for visitor interface (below)
    ...
    template<class RhsT>
    static void
    construct_impl(void* addr, const void* obj)
    {
  ...
  private:
    // silence MSVC warning C4512: assignment operator could not be generated
    backup_assigner&
    operator= (backup_assigner const&);
#endif
};
    ...
    : public static_visitor<const boost::typeindex::type_info&>
{
  public: // visitor interfaces
    ...
    operator()(const T&) const BOOST_NOEXCEPT
    {
    ...
    : public static_visitor<bool>
{
  ...
  public: // structors
    ...
    explicit
    comparer(const Variant& lhs) BOOST_NOEXCEPT
  :
    lhs_(lhs)
    {
    }
...
#   if BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x0564))
    template <typename T>
    result_type
    internal_visit(const T& operand, int)
    {
        return visitor_(operand);
    }
#   endif //BORLAND
...
#undef BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS
  ...
  public:
    ...
    void
    indicate_which(int which_arg) BOOST_NOEXCEPT
    {
        which_ = static_cast<which_t>( which_arg );
    }

    void
    indicate_backup_which(int which_arg) BOOST_NOEXCEPT
    {
  ...
  private: // helpers, for queries (below)
    ...
    bool
    using_backup() const BOOST_NOEXCEPT
    {
        return which_ < 0;
    }
  ...
  private: // helpers, for structors (below)
    ...
    void
    destroy_content() BOOST_NOEXCEPT
    {
  ...
  private: // helpers, for structors, cont. (below)
        ...
        : public static_visitor<int>
    {
      ...
      public: // structors
        ...
        explicit
        convert_copy_into(void* storage) BOOST_NOEXCEPT
      :
        storage_(storage)
        {
        }
...
#   endif
        ...
        template <typename T>
        int
        internal_visit(boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
        ...
        template <typename T>
        int
        internal_visit(const boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
        ...
        : public static_visitor<int>
    {
      ...
      public: // structors
        ...
        explicit
        convert_move_into(void* storage) BOOST_NOEXCEPT
      :
        storage_(storage)
        {
        }
...
#   endif
        ...
        : public static_visitor<>
    {
      ...
      protected: // helpers, for internal visitor interface (below)
        ...
        void
        construct_fallback() const BOOST_NOEXCEPT
        {
    ...
    void
    variant_assign(const variant& rhs)
    {
