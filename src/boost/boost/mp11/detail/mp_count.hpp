...
template<class T1, class... T> constexpr std::size_t
cx_plus(T1 t1, T... t)
{
...
constexpr std::size_t
cx_plus(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T... t)
{
...
template<class V, class... T> constexpr std::size_t
cx_count()
{
...
template<template<class...> class P, class... T> constexpr std::size_t
cx_count_if()
{
