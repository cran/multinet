...
)
{
    ...
    cube_ = std::make_unique<olap::CCube<VertexStore>>(dimensions, members, elements.begin(), elements.end());
}
          ...
          )
    {
        ...
        //cube_ = std::make_unique<olap::CCube<VertexStore>>(dim, members, begin, end);
        ...
        cube_ = std::make_unique<olap::CCube<VertexStore>>(dimensions, members, begin, end);
    }
...
*/
           ...
           )
    {
        ...
        auto iter = olap::sel::IndexIterator(indexes);
