...
#include "net/datastructures/Graph.hpp"
#include "net/datastructures/Vertex.hpp"
#include "net/datastructures/Edge.hpp"
#include "tnet/datastructures/TemporalAttributeStore.hpp"
