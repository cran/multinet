...
#include "mnet/datastructures/observers/LayerPropagateObserver.h"
...
LayerObserver(
    ...
    store_(store)
{
    assert_not_null(store_, "LayerObserver::constructor", "store");
}
...
{
    assert_not_null(obj, "LayerObserver::notify_add", "obj");
...
{
    assert_not_null(obj, "LayerObserver::notify_erase", "obj");
