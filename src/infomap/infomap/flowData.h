...
struct FlowUndirected
{
    ...
    {}
    FlowUndirected&
    operator=(const FlowUndirected& other)
    {
        flow = other.flow;
        exitFlow = other.exitFlow;
        return *this;
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const FlowUndirected& data)
    {
...
struct FlowDirected
{
    ...
    {}
    FlowDirected&
    operator=(const FlowDirected& other)
    {
        flow = other.flow;
        exitFlow = other.exitFlow;
        return *this;
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const FlowDirected& data)
    {
        return out << "flow: " << data.flow << ", exit: " << data.exitFlow;
    }
};
...
struct FlowDirectedWithTeleportation
{
    ...
    {}
    FlowDirectedWithTeleportation&
    operator=(const FlowDirectedWithTeleportation& other)
    {
        flow = other.flow;
        exitFlow = other.exitFlow;
        enterFlow = other.enterFlow;
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const FlowDirectedWithTeleportation& data)
    {
        //		return out << "flow: " << data.flow << ", exit: " << data.exitFlow;
        return out << "flow: " << data.flow << ", exit: " << data.exitFlow <<
...
struct FlowDirectedNonDetailedBalance
{
    ...
    FlowDirectedNonDetailedBalance(const FlowDirectedNonDetailedBalance& other) :
        ...
        exitFlow(other.exitFlow)
    {}
    FlowDirectedNonDetailedBalance&
    operator=(const FlowDirectedNonDetailedBalance& other)
    {
        flow = other.flow;
        enterFlow = other.enterFlow;
        exitFlow = other.exitFlow;
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const FlowDirectedNonDetailedBalance& data)
    {
...
struct FlowDirectedNonDetailedBalanceWithTeleportation
{
    ...
    FlowDirectedNonDetailedBalanceWithTeleportation(const FlowDirectedNonDetailedBalanceWithTeleportation& other) :
        ...
        danglingFlow(other.danglingFlow)
    {}
    FlowDirectedNonDetailedBalanceWithTeleportation&
    operator=(const FlowDirectedNonDetailedBalanceWithTeleportation& other)
    {
        flow = other.flow;
        enterFlow = other.enterFlow;
        exitFlow = other.exitFlow;
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const FlowDirectedNonDetailedBalanceWithTeleportation& data)
    {
        return out << "flow: " << data.flow << ", enter: " << data.enterFlow << ", exit: " << data.exitFlow;
    }
};
...
struct FlowDummy
{
    ...
    FlowDummy&
    operator=(const FlowDummy& other)
    {
        flow = other.flow;
        enterFlow = other.enterFlow;
        exitFlow = other.exitFlow;
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const FlowDummy& data)
    {
        return out << "flow: " << data.flow << ", enter: " << data.enterFlow << ", exit: " << data.exitFlow;
    }
};
...
struct DeltaFlow
{
    ...
    DeltaFlow&
    operator=(DeltaFlow other) // Assignment operator (copy-and-swap idiom)
    {
        swap(*this, other);
        return *this;
    }
    ...
    DeltaFlow&
    operator +=(const DeltaFlow& other)
    {
        module = other.module;
        deltaExit += other.deltaExit;
        deltaEnter += other.deltaEnter;
    ...
    friend void
    swap(DeltaFlow& first, DeltaFlow& second)
    {
...
struct MemDeltaFlow : DeltaFlow
{
    ...
    MemDeltaFlow&
    operator=(MemDeltaFlow other) // Assignment operator (copy-and-swap idiom)
    {
        swap(*this, other);
        return *this;
    }
    ...
    void
    addMemFlowTerms(double _sumDeltaPlogpPhysFlow, double _sumPlogpPhysFlow)
    {
    ...
    friend void
    swap(MemDeltaFlow& first, MemDeltaFlow& second)
    {
        std::swap(first.module, second.module);
        std::swap(first.deltaExit, second.deltaExit);
        std::swap(first.deltaEnter, second.deltaEnter);
