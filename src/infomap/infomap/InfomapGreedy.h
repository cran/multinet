...
class InfomapGreedy : public InfomapBase
{
  ...
  protected:
    ...
    virtual void
    resetModuleFlow(NodeBase& node);

    virtual void
    transformNodeFlowToEnterFlow(NodeBase* parent);

    virtual void
    cloneFlowData(const NodeBase& source, NodeBase& target);

    virtual void
    printNodeRanks(std::ostream& out);

    virtual void
    printFlowNetwork(std::ostream& out);

    virtual void
    sortTree(NodeBase& parent);

    virtual void
    saveHierarchicalNetwork(HierarchicalNetwork& output, std::string rootName, bool includeLinks);
    void
    buildHierarchicalNetworkHelper(HierarchicalNetwork& hierarchicalNetwork, HierarchicalNetwork::node_type& parent, std::vector<std::string>& leafNodeNames, NodeBase* node = 0);
    // Don't add leaf nodes, but collect all leaf modules instead
    void
    buildHierarchicalNetworkHelper(HierarchicalNetwork& hierarchicalNetwork, HierarchicalNetwork::node_type& parent, std::deque<std::pair<NodeBase*, HierarchicalNetwork::node_type*> >& leafModules, NodeBase* node = 0);
...
inline
void
InfomapGreedy<InfomapImplementation>::printNodeRanks(std::ostream& out)
{
    out << "#node-flow\n";
...
inline
void
InfomapGreedy<InfomapImplementation>::printFlowNetwork(std::ostream& out)
{
...
inline
void
InfomapGreedy<InfomapImplementation>::sortTree(NodeBase& parent)
{
...
inline
void
InfomapGreedy<InfomapImplementation>::saveHierarchicalNetwork(HierarchicalNetwork& output, std::string rootName, bool includeLinks)
{
...
inline
void
InfomapGreedy<InfomapImplementation>::buildHierarchicalNetworkHelper(HierarchicalNetwork& hierarchicalNetwork, HierarchicalNetwork::node_type& parent, std::vector<std::string>& leafNodeNames, NodeBase* rootNode)
{
    if (rootNode == 0)
    {
        rootNode = root();
...
inline
void
InfomapGreedy<InfomapImplementation>::buildHierarchicalNetworkHelper(HierarchicalNetwork& hierarchicalNetwork, HierarchicalNetwork::node_type& parent, std::deque<std::pair<NodeBase*, HierarchicalNetwork::node_type*> >& leafModules, NodeBase* rootNode)
{
    if (rootNode == 0)
    {
        rootNode = root();
...
template<typename InfomapImplementation>
void
InfomapGreedy<InfomapImplementation>::resetModuleFlowFromLeafNodes()
{
...
template<typename InfomapImplementation>
void
InfomapGreedy<InfomapImplementation>::resetModuleFlow(NodeBase& node)
{
...
inline
void
InfomapGreedy<InfomapImplementation>::transformNodeFlowToEnterFlow(NodeBase* parent)
{
...
template<typename InfomapImplementation>
void
InfomapGreedy<InfomapImplementation>::cloneFlowData(const NodeBase& source, NodeBase& target)
{
...
template<typename InfomapImplementation>
inline
typename InfomapGreedy<InfomapImplementation>::NodeType&
InfomapGreedy<InfomapImplementation>::getNode(NodeBase& node)
{
...
template<typename InfomapImplementation>
inline
const typename InfomapGreedy<InfomapImplementation>::NodeType&
InfomapGreedy<InfomapImplementation>::getNode(const NodeBase& node) const
{
...
inline
unsigned int
InfomapGreedy<InfomapImplementation>::numActiveModules()
{
...
inline
unsigned int
InfomapGreedy<InfomapImplementation>::numDynamicModules()
{
    return m_activeNetwork.size() - m_emptyModules.size();
}
...
inline
InfomapImplementation&
InfomapGreedy<InfomapImplementation>::getImpl()
{
...
inline
InfomapImplementation&
InfomapGreedy<InfomapImplementation>::getImpl(InfomapBase& infomap)
{
...
inline
FlowDummy
InfomapGreedy<InfomapImplementation>::getNodeData(NodeBase& node)
{
